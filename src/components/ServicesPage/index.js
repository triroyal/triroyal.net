...
const ServicesPage = () => (
  <div className="container centered vertical px-5 pb-5">
    ...
    <p className="align-image justify pb-4">
      ...
      diharapkan dapat menyingkat durasi pengerjaan dan penghematan biaya, juga
    ...
    <p className="align-image justify">
      ...
      tehnik-tehnik baru yang dinilai dapat memberikan hasil yang lebih efektif
      dengan tetap mempertahankan kualitas terbaik untuk klien. Salah satunya
      adalah sistem perebusan baru dengan Oblique Sterilizer untuk menggantikan
      rebusan berbentuk horizontal yang selama ini banyak digunakan di
      pabrik-pabrik kelapa sawit di Indonesia. Kami bertekad untuk terus
      mengembangkan layanan kami dengan tujuan agar klien mendapatkan hasil
